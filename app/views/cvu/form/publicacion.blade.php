...
@section('content')
<h3>Ingrese la informacion referente a sus publicaciones</h3>
<hr>
...
{{Form::text('nom_pub', Input::old('nom_pub'), array('class'=>'form-control', 'placeholder'=>'Ingrese el nombre de su publicacion', 'autocomplete'=>'off'))}} 
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            {{Form::label('tipo_pub', 'Tipo de publicacion')}}
{{Form::text('tipo_pub', Input::old('tipo_pub'), array('class'=>'form-control', 'placeholder'=>'Ingrese el tipo de publicacion', 'autocomplete'=>'off'))}} 
        </div>
    </div>
</div>
<div class="form-group">
