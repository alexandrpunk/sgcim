...
@section('content')
<h3><a href="{{URL::to('cvu/personal');}}" title="Regresar" class="small text-primary"><i class="glyphicon glyphicon glyphicon-chevron-left"></i>&nbsp;</a>Ingrese sus datos personales</h3>
<hr>
@if(isset($personal))
